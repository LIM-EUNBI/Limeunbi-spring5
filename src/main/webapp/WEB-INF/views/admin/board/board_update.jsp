            ...
            <form name="form_write" method="post" action="/admin/board/board_update" enctype="multipart/form-data">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group div_file-delete">
                    <div class="custom-file">
                      <input name="file" type="file" class="custom-file-input" id="file_${idx }">
                      <label class="custom-file-label" for="file_${idx }">파일 선택</label>
                   	<c:if test="${boardVO.save_file_names[idx] != null} ">
                   		<p class="text-muted">
                   		<a href="/download?save_file_name=${boardVO.save_file_names[idx]}&real_file_name=${boardVO.real_file_names[idx]}">${boardVO.real_file_names[idx] }</a>
