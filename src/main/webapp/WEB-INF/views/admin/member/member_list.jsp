          ...
          <div class="card-body table-responsive p-0">
            <table class="table table-hover">
              ...
              <c:forEach var="memberVO" items="${listMember}">              
                <tr style="cursor: pointer;" onclick="location.replace('/admin/member/member_view?page=${pageVO.page }&user_id=${memberVO.user_id}&search_type=${pageVO.search_type }&search_keyword=${pageVO.search_keyword }');">
